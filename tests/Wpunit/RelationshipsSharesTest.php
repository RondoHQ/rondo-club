...
class RelationshipsSharesTest extends CaelisTestCase {
    ...
    public function test_person_dates_endpoint_returns_linked_dates(): void {
        ...
        $date_id = $this->createImportantDate( $person_id, [
            'post_author' => $alice_id,
            'post_title'  => 'Birthday',
        ], [
    ...
    public function test_people_share_add(): void {
        ...
        $response = $this->restRequest( 'POST', '/prm/v1/people/' . $person_id . '/shares', [
            'user_id'    => $bob_id,
            'permission' => 'view',
        ] );
    ...
    public function test_share_permission_update(): void {
        ...
        $this->restRequest( 'POST', '/prm/v1/people/' . $person_id . '/shares', [
            'user_id'    => $bob_id,
            'permission' => 'view',
        ] );
    ...
    public function test_companies_share_lifecycle(): void {
        ...
        // POST share
        $add_response = $this->restRequest( 'POST', '/prm/v1/companies/' . $company_id . '/shares', [
            'user_id'    => $bob_id,
            'permission' => 'view',
        ] );
    ...
    public function test_people_bulk_update_visibility(): void {
        ...
        // Create 3 persons
        $person1_id = $this->createPerson( [ 'post_author' => $alice_id, 'post_title' => 'Bulk Person 1' ] );
        $person2_id = $this->createPerson( [ 'post_author' => $alice_id, 'post_title' => 'Bulk Person 2' ] );
        $person3_id = $this->createPerson( [ 'post_author' => $alice_id, 'post_title' => 'Bulk Person 3' ] );
        ...
        $response = $this->restRequest( 'POST', '/prm/v1/people/bulk-update', [
    ...
    public function test_companies_bulk_update_visibility(): void {
        ...
        // Create 2 companies
        $company1_id = $this->createOrganization( [ 'post_author' => $alice_id, 'post_title' => 'Company 1' ] );
        $company2_id = $this->createOrganization( [ 'post_author' => $alice_id, 'post_title' => 'Company 2' ] );

        // Bulk update visibility
        $response = $this->restRequest( 'POST', '/prm/v1/companies/bulk-update', [
