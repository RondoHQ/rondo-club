...
class ListPreferenceMigrationTest extends RondoTestCase {
	...
	public function test_all_people_list_preference_shapes_migrate_without_resetting_values(): void {
		...
		$this->assertSame( 3, (int) get_user_meta( $user_id, 'rondo_people_list_pref_version', true ) );
		$this->assertSame( [ 'team', 'knvb_id', 'datum_vog', 'birthdate' ], get_user_meta( $user_id, 'rondo_people_list_preferences', true ) );
