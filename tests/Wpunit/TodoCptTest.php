...
class TodoCptTest extends CaelisTestCase {
    ...
    public function test_update_todo_changes_status(): void {
        ...
        $person_id = $this->createPerson( [ 'post_author' => $user_id, 'post_title' => 'Test Person' ] );
        $todo_id = $this->createTodo( $person_id, $user_id, [ 'content' => 'Test todo', 'status' => 'open' ] );
    ...
    public function test_dashboard_counts_open_todos(): void {
        ...
        $person_id = $this->createPerson( [ 'post_author' => $user_id, 'post_title' => 'Test Person' ] );
        $this->createTodo( $person_id, $user_id, [ 'content' => 'Todo 1', 'status' => 'open' ] );
        $this->createTodo( $person_id, $user_id, [ 'content' => 'Todo 2', 'status' => 'open' ] );
        $this->createTodo( $person_id, $user_id, [ 'content' => 'Todo 3', 'status' => 'open' ] );
    ...
    public function test_completed_todos_not_counted(): void {
        ...
        $this->createTodo( $person_id, $user_id, [ 'content' => 'Open 1', 'status' => 'open' ] );
        $this->createTodo( $person_id, $user_id, [ 'content' => 'Open 2', 'status' => 'open' ] );
        $this->createTodo( $person_id, $user_id, [ 'content' => 'Completed 1', 'status' => 'completed' ] );
        $this->createTodo( $person_id, $user_id, [ 'content' => 'Completed 2', 'status' => 'completed' ] );
    ...
    public function test_todos_returns_open_by_default(): void {
        ...
        $open_todo = $this->createTodo( $person_id, $user_id, [ 'content' => 'Open todo', 'status' => 'open' ] );
        $completed_todo = $this->createTodo( $person_id, $user_id, [ 'content' => 'Completed todo', 'status' => 'completed' ] );
        $awaiting_todo = $this->createTodo( $person_id, $user_id, [ 'content' => 'Awaiting todo', 'status' => 'awaiting' ] );
    ...
    public function test_todos_with_status_awaiting_returns_only_awaiting(): void {
        ...
        $awaiting1 = $this->createTodo( $person_id, $user_id, [ 'content' => 'Awaiting 1', 'status' => 'awaiting' ] );
        $awaiting2 = $this->createTodo( $person_id, $user_id, [ 'content' => 'Awaiting 2', 'status' => 'awaiting' ] );
        $open_todo = $this->createTodo( $person_id, $user_id, [ 'content' => 'Open', 'status' => 'open' ] );
        $completed_todo = $this->createTodo( $person_id, $user_id, [ 'content' => 'Completed', 'status' => 'completed' ] );
    ...
    public function test_todos_status_filters_are_mutually_exclusive(): void {
        ...
        $open_todo = $this->createTodo( $person_id, $user_id, [ 'content' => 'Open', 'status' => 'open' ] );
        $awaiting_todo = $this->createTodo( $person_id, $user_id, [ 'content' => 'Awaiting', 'status' => 'awaiting' ] );
        $completed_todo = $this->createTodo( $person_id, $user_id, [ 'content' => 'Completed', 'status' => 'completed' ] );
