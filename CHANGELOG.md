...
- Two-finger pinch zoom in the photo cropper, preserving the subject under the fingers and smoothly continuing with one-finger dragging.

## [35.61.0] - 2026-09-12

### Added

- Crop profile photos before saving: square preview, drag and keyboard positioning, zoom, cancellation, and bounded JPEG export.
- Single-person Sportlink photo pilot with durable photo revisions, visible status, administrator-only export/claim/confirmation, and a July 1 through October 31 window in Europe/Amsterdam.

### Changed

- Explicitly distinguish manual photo uploads from Sportlink imports; preserve manually uploaded photos throughout the pilot, including after confirmation, to prevent stale imports and upload loops.
