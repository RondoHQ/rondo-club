...
### Fixed
- Board dashboard membership totals, season inflow and outflow now count only playing association members and explicitly name that scope. Outflow is labelled incomplete when departed association members have no recorded playing activity.

## [35.100.1] - 2026-09-23

### Fixed
- Link feedback submitters to their accessible person profile from “Submitted by”.
...
### Added
- Shared tournament payment overview for tournament coordinators and finance readers, with tournament, team and payment-status filters, filtered totals, invoice numbers, payment dates and payment methods.
- Read-only tournament payments endpoint using existing invoice payment states without granting tournament management or general invoice access.
...
### Changed
- Rename the personal tournament menu, page title, back link and email action to Toernooien.
...
### Fixed
- Bestaande koppelingen naar gearchiveerde teams blokkeren het opslaan van andere wijzigingen in het trainingsschema niet meer. Nieuwe koppelingen naar inactieve teams blijven geweigerd.
- Toon fouten en overlapmeldingen direct bij de knop ‘Schema opslaan’, met behoud van niet-opgeslagen wijzigingen.

## [35.96.1] - 2026-09-21

### Changed
- De tweewekelijkse vrijwilligersmail licht onder de inschrijfknop toe dat leden kunnen worden ingedeeld als zij niet aan het vrijwilligersbeleid voldoen, met een link naar het beleid en uitleg over de toewijzingsmail, ruilen en vervanging.

## [35.96.0] - 2026-09-21

### Added
- Privé-overzicht “Nog in te delen” voor vrijwilligersbeheerders en bestuur: filter op afgeronde en ingeplande diensten, toon gezinsverplichtingen één keer en wijs direct passende diensten toe met de bestaande toewijzingsmail.

## [35.95.1] - 2026-09-21

### Changed
- De tweewekelijkse vrijwilligersmail toont beschikbare diensten voor de drie eerstvolgende weekenden, met behoud van zondag 19:00 als verzendmoment.
...
### Added
- Links to published task instructions in volunteer reminder emails, automatically matched to the task type.
- Playing-day labels beside teams in volunteer statistics to distinguish Saturday and Sunday teams.

### Fixed
- Sort team names naturally by age group and team number in ascending and descending order.

## [35.91.0] - 2026-09-19

### Added
- Typed MCP actions to create feedback and update its workflow through the existing domain API, including notification delivery evidence, administrator-only workflow changes and validation before writes.
...
### Fixed
- Allow sponsor contacts without personal names to activate accounts using their company name, with valid unique usernames and company display names.
...
### Changed
- Move the volunteer team overview into a separate Per team statistics tab, hide teams without people, and preserve the selected tab when changing season.

## [35.86.0] - 2026-09-18

### Added
- Team overview in volunteer statistics for board members and volunteer managers, showing current members and linked parents, unique Rondo accounts, required duties after exemptions, and registered duties. Family duties may count for each child.
...
### Fixed
- Grant roles from current committee memberships immediately when an account is created, including through self-service activation, using the same role reconciliation as subsequent synchronization.

## [35.84.1] - 2026-09-16

### Changed
- Open Relaties as the start page for scoped year-group coordinators and remove Dashboard from their navigation.
...
### Fixed
- Include KNVB playing time, halftime and pupil time-outs in team calendar end times, with age and division exceptions. O17 matches now reserve 95 minutes; existing subscriptions keep their event IDs and receive updated revisions.
...
### Fixed
- Recognize active Verenigingsscheidsrechter assignments in the default roles exempt from volunteer duties.
...
### Added
- Football landing page tiles linking to the accessible football pages, using the same order and permissions as the sidebar.

### Fixed
- Allow active sidebar sections to be collapsed and preserve the choice across navigation and reloads.
...
### Added
- Editable onboarding draft blocks and full branded previews for member, volunteer and combined welcome emails, including age, recipient-account, VOG and clothing scenarios.
- Preserve existing manual templates as a comparison source; draft saves and previews never enable or send onboarding mail.

## [35.75.0] - 2026-09-13

### Added
- Persistent source inventory and targeted onboarding checks in the regular member import, with conservative baseline handling, explicit completeness checks and retries; automatic email remains disabled.

### Fixed
- Keep pending source checks visible as onboarding blockers, even when an older observation was complete.
...
### Changed
- Move team calendar subscriptions from Mijn gegevens to the selected team on Mijn team.

## [35.73.2] - 2026-09-12

### Fixed
- Keep the onboarding simulation notice and result count readable in dark mode, and use singular wording for one result.

## [35.73.1] - 2026-09-12

### Fixed
- Match training times on Mijn team to the roster cards with rounded corners, a subtle border, and a plain heading.

## [35.73.0] - 2026-09-12

### Added
- Administrator-only onboarding simulation in the existing email settings, showing recipient selection, source coverage, planning blockers and mail-block decisions without sending email.
- Native private onboarding rounds, an authenticated observation contract and durable per-recipient delivery reservations for subsequent automation work. First observations are treated as baseline; no scheduler or automatic sends are enabled.

### Fixed
- Explicit role start and end dates take precedence over stale current-role flags when selecting volunteers and VOG requirements.
...
### Changed
- Make all training schedule read endpoints public regardless of the feature flag, including direct browser access without a REST nonce. Settings and write operations remain restricted to administrators and follow the flag.
...
- Place Trainingsschema under Teams alongside Kaderlijst in the sidebar.

## [35.70.1] - 2026-09-12

### Fixed

- Keep Kaderlijst grouped under Teams when the training planner is visible, and display the training page title in the app header.
...
- Add a WhatsApp button beside visible mobile numbers in Mijn team for staff, players, and parents, preserving existing contact permissions and supporting international mobile numbers.
...
- Enlarge the profile photo to 112 pixels, show the company name after the person's name and place role badges beside demographic details with responsive wrapping.
...
- Use an icon-only VOG edit control with the same pencil size and gray styling as address editing, retaining its accessible label and expanded state.
...
- Crop profile photos before saving with a square preview, dragging, two-finger pinch zoom, a zoom slider, keyboard positioning, reset and cancellation. Saving exports a JPEG up to 800 × 800 pixels without enlarging small crops.

### Fixed

- Make the profile photo edit control accessible by keyboard and refresh the person photo after saving.

## [35.60.4] - 2026-09-12

### Fixed

- Preserve sponsor-company contacts, Sponsit source IDs and pass settings when merging people, include sponsor links in the preview, and block conflicting sponsor identities or primary passes before making changes.

## [35.60.3] - 2026-09-11

### Fixed

- Respect future invoice send dates when sending manually or in bulk: scheduled invoices remain queued until their date, and sending early requires explicitly cancelling the schedule first.
...
- Clear stale VOG file selections after invalid replacements or source changes, preventing accidental submission of a previously selected document.
...
- Name Rondo on the single-person activation confirmation and explain that password setup comes next, replacing irrelevant guidance about activating another account.

## [35.59.6] - 2026-09-09

### Changed

- Introduce Rondo and its account benefits in activation emails, remove the redundant Account label, and explain the activation steps before the button with validity and unsolicited-request guidance below it.
...
- Clarify account activation with an illustrated list of account benefits, club-branded newsletter email guidance and an explanation of parent accounts.

## [35.59.3] - 2026-09-07

### Fixed

- Keep explicitly inactive roles without an end date in team history while excluding them from current rosters, counts, fee matching, staff lists and role eligibility.

## [35.59.2] - 2026-09-07

### Fixed

- Style the native app consent screen with the connected club’s logo, Rondo branding, compact permission text and accessible mobile buttons.

## [35.59.1] - 2026-09-07

### Fixed

- Repair mobile account activation with a full-width submit button, compact header, readable spacing and selectable identity cards; show the parent name field only when a parent/guardian identity is selected.
- Skip the identity picker when only one person without a parent/guardian option can activate; show their name and the account creation button directly.
...
- Select multiple age groups in the People filter to combine them into one list, including pagination and CSV export (feedback #10328).

## [35.57.1] - 2026-09-07

### Fixed

- Recalculate invoice due dates from the scheduled send date and configured payment term when creating or rescheduling a draft, including bulk scheduling and the draft editor.
- Clear outdated draft PDFs when rescheduling an invoice.

## [35.57.0] - 2026-09-07

### Added

- Current teams and shareable calendar subscription links on each person's My Details card.

### Fixed

- Calendar subscription buttons now open visible instructions and a copyable URL for Google Calendar, Outlook, and device calendar apps, including browsers without a webcal handler.

## [35.56.1] - 2026-09-07

### Fixed

- Match local team names containing WordPress smart apostrophes to their Sportlink programme and calendar.

## [35.56.0] - 2026-09-07

### Added

- Team match overview covering the current season, including home and away fixtures, results, cancellations, and upcoming/past filters.
- Stable ICS subscription links per team with rescheduling updates, cancellation tracking, and cached data during Sportlink outages.

## [35.55.5] - 2026-09-07

### Changed

- Remove the Kaderlijst group column so the roster starts with Team, while retaining the age-group and year filters.

## [35.55.4] - 2026-09-07

### Changed

- Combine Kaderlijst age group and year into one compact Groep column while retaining separate age-group and year filters.

## [35.55.3] - 2026-09-07

### Changed

- Keep the Kaderlijst name column at a compact 180px target width, wrapping long names and leaving spare space after the contact details.

### Added

- Add a WhatsApp shortcut beside each Kaderlijst phone number, alongside the existing telephone and email links.

## [35.55.2] - 2026-09-07

### Changed

- Make the Kaderlijst easier to scan with a compact age-group column, a combined full-name column, and clear separators between teams.

### Fixed

- Keep Kaderlijst group labels and team separators aligned with the visible rows after filtering or sorting.
...
- De kaderlijst toont dezelfde persoon, hetzelfde team en dezelfde functie één keer wanneer meerdere actuele functiehistoriekregels dezelfde inzet beschrijven.
...
- Nieuwe en gewijzigde adressen gebruiken standaard Nederland en landcode NL; lege landen of landcodes worden niet meer opgeslagen en kunnen de Sportlink reverse sync niet meer blokkeren.

## [35.45.0] - 2026-09-05

### Added

- Toegangsstatistieken in het desktop- en mobiele menu: bekijk live aantallen per pastype en blader terug naar eerdere wedstrijden zonder zelf te scannen.

## [35.44.2] - 2026-09-05

### Fixed

- Oud-leden met een geldig sponsorrecht kunnen hun sponsorpas gebruiken, inclusief Wallet en QR-toegangscontrole; reguliere ledenpassen blijven geblokkeerd bij beëindigd lidmaatschap.
...
- Beheerders kunnen onder **Instellingen → Club** kiezen welk team gastpassen gebruikt; actuele spelers en stafleden van dat team kunnen op **Mijn gegevens** twee vaste gastlinks delen en iedere gast bewaart na eenmalige registratie een herbruikbare Apple Wallet-, Google Wallet- of QR-pas.
...
- Het financieel dashboard toont bij factuurstatussen geen aantallen meer voor Verstuurd en Betaald; Factuurbedragen toont alleen het openstaande bedrag.
- De afgeronde melding van een contributiefactuurrun verdwijnt zodra de verwerking klaar is.
...
- Club TV gebruikt voortaan dezelfde tabstijl als Instellingen, met aparte tabbladen voor Players en Instellingen.
- Het formulier om een player te koppelen opent voortaan vanuit een compacte knop in een popover.
...
- De scherminstelling heet nu definitief “Browserpresentaties” in plaats van “Browserpresentaties testen”.

## [35.6.3] - 2026-08-24

### Fixed

- Het zoekicoon in de houder- en presentatorenvelden overlapt de placeholdertekst niet meer.

## [35.6.2] - 2026-08-24

### Fixed

- De reserveringsknop blijft beschikbaar voor vrijwilligersfuncties waarvan het gekoppelde commissie- of teamtype niet expliciet in de werkhistorie staat.
...
- Club TV-afbeeldingsslides schalen voortaan groot op binnen de beschikbare schermruimte zonder de afbeelding bij te snijden.
...
- Apple Wallet- en Google Wallet-acties werken nu ook voor gewone ledenaccounts; de frontendactie via `admin-post.php` wordt niet meer door de wp-admin-blokkade naar de homepage gestuurd.

## [35.0.2] - 2026-08-23

### Fixed

- Apple Wallet- en Google Wallet-links blijven op mobiel geldig zolang dezelfde Rondo-inlogsessie actief is, zodat een bewaarde pagina niet meer met een verlopen nonce op de homepage of een foutpagina eindigt.
...
- Beheerders kunnen vanuit de accountkaart op een persoonspagina via de plugin User Switching naar het gekoppelde gebruikersaccount wisselen.
...
- De volledige persoonskaart in **Mijn gegevens** gebruikt op brede schermen een compactere leesbreedte.

## [34.28.7] - 2026-08-22

### Changed

- Het ledenpasblok in **Mijn gegevens** gebruikt op brede schermen een compactere leesbreedte.
...
- De sponsorweergave in **Mijn gegevens** markeert het bedrijf als **Sponsor** en de gekoppelde persoon als **Contactpersoon**.
...
- De WordPress-testopstart in CI krijgt genoeg tijd op tragere gedeelde runners, zodat een geldige release niet vóór de eigenlijke tests wordt afgebroken.
...
- Commissie-overzichten tonen hun basisgegevens direct terwijl ledentellingen apart laden; individuele commissies zoeken hun leden gericht op in plaats van alle personen te doorlopen.
