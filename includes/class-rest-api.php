...
class Api extends Base {
	...
	public function update_club_config( $request ) {
		...
		$freescout_retention = $request->get_param( 'freescout_audit_retention_days' );
		if ( $freescout_retention !== null && ! \Rondo\Integrations\FreeScout\Config::update_retention( (int) $freescout_retention ) ) {
			return new \WP_Error(
				'rondo_freescout_retention_locked',
