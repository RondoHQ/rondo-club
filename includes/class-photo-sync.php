<?php
/**
 * Durable, revision-bound photo jobs for the single-person Sportlink pilot.
 */
...
class PhotoSync {
	...
	public static function status( int $person_id ): ?array {
		...
		$messages = [
			'pending'        => 'Foto opgeslagen in Rondo; klaar voor de proef met Sportlink.',
	...
	/** Incoming imports never overwrite a manually owned photo during the pilot. */
