...
final class OidcProvider {
	...
	public function register_rewrite_rules(): void {
		add_rewrite_rule( '^\.well-known/openid-configuration/?$', 'index.php?' . self::QUERY_ENDPOINT . '=discovery', 'top' );
		add_rewrite_rule( '^\.well-known/oauth-authorization-server/?$', 'index.php?' . self::QUERY_ENDPOINT . '=metadata', 'top' );
