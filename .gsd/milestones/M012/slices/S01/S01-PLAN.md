...
- [ ] **T01: Extract UserSettings controller** `est:45min`
...
- [ ] **T02: Extract Users controller** `est:30min`
...
- [ ] **T03: Wire up in functions.php and remove from Api** `est:20min`
...
- [ ] **T04: Build, deploy, and verify** `est:15min`
