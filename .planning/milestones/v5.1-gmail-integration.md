...
#### `Stadion\REST\Gmail`
- `GET /stadion/v1/gmail/status` - Connection status
- `GET /stadion/v1/gmail/threads` - List threads for a contact
- `GET /stadion/v1/gmail/threads/{id}` - Get thread details
- `POST /stadion/v1/gmail/send` - Send email
- `POST /stadion/v1/gmail/threads/{id}/log` - Log thread as activity
- `GET /stadion/v1/gmail/search` - Search emails
- `GET /stadion/v1/gmail/preferences` - Get preferences
- `PUT /stadion/v1/gmail/preferences` - Update preferences
...
|--------|----------|-------------|
| GET | `/stadion/v1/gmail/status` | Gmail connection status, quota usage |
| GET | `/stadion/v1/gmail/threads` | List threads (params: emails[], maxResults, pageToken) |
| GET | `/stadion/v1/gmail/threads/{id}` | Get full thread with messages |
| POST | `/stadion/v1/gmail/send` | Send new email or reply |
| POST | `/stadion/v1/gmail/threads/{id}/log` | Log thread as activity |
| GET | `/stadion/v1/gmail/search` | Search (params: query, emails[], maxResults) |
| GET | `/stadion/v1/gmail/preferences` | Get user's Gmail preferences |
| PUT | `/stadion/v1/gmail/preferences` | Update preferences |
| GET | `/stadion/v1/people/{id}/emails` | Shortcut: threads for a person |
| POST | `/stadion/v1/people/{id}/emails/send` | Shortcut: send to a person |
...
- [ ] REST endpoint: `GET /stadion/v1/people/{id}/emails`
...
- [ ] REST endpoint: `POST /stadion/v1/gmail/send`
...
- [ ] REST endpoint: `GET /stadion/v1/gmail/search`
