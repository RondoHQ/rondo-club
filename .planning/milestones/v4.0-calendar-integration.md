...
Plans:
- [x] 48-01: Google OAuth flow (google/apiclient, STADION_Google_OAuth class, REST endpoints)
...
Plans:
- [x] 49-01: Google Calendar sync provider (STADION_Google_Calendar_Provider, trigger_sync, get_events)
...
Plans:
- [x] 50-01: CalDAV provider (STADION_CalDAV_Provider, test_caldav, sync for iCloud/Fastmail/Nextcloud)
...
Plans:
- [x] 51-01: Contact matching (STADION_Calendar_Matcher class, provider integration, meetings endpoint)
...
Plans:
- [x] 54-01: Background sync (STADION_Calendar_Sync class, WP-Cron, auto-logging, WP-CLI commands)
