# Requirements Archive: v8.0 PWA Enhancement
...
- [x] **INST-01**: Android users see smart install prompt after multiple visits (dismissable, remembers preference)
- [x] **INST-02**: iOS users can access manual install instructions modal explaining Add to Home Screen
- [x] **INST-03**: Users see update notification when new version available with refresh button
...
| INST-01 | Phase 110 | Complete |
| INST-02 | Phase 110 | Complete |
| INST-03 | Phase 110 | Complete |
...
**Shipped:** 14 of 14 v8.0 requirements
**Adjusted:** None
**Dropped:** None

---
*Archived: 2026-01-28 as part of v8.0 milestone completion*
