...
**Accomplishments:**
- Created STADION_REST_People class with 5 people-specific methods (3 routes)
- Created STADION_REST_Companies class with 3 company-specific methods (3 routes)
...
**Accomplishments:**
- Created STADION_REST_Slack class with 10 Slack-specific routes
- Created STADION_REST_Import_Export class with 3 routes and 5 methods
...
**Accomplishments:**
- Added three protected sanitization helper methods to STADION_REST_Base
