...
- `GET /stadion/v1/google-contacts/status` - Connection and sync status
- `POST /stadion/v1/google-contacts/connect` - Initiate OAuth flow
- `POST /stadion/v1/google-contacts/disconnect` - Revoke and cleanup
- `POST /stadion/v1/google-contacts/sync` - Trigger manual sync
- `GET /stadion/v1/google-contacts/conflicts` - List pending conflicts
- `POST /stadion/v1/google-contacts/conflicts/{id}/resolve` - Resolve conflict
- `GET /stadion/v1/google-contacts/log` - Sync history
...
|--------|----------|-------------|
| GET | `/stadion/v1/google-contacts/status` | Get connection status, last sync, stats |
| POST | `/stadion/v1/google-contacts/connect` | Start OAuth flow (returns auth URL) |
| GET | `/stadion/v1/google-contacts/callback` | OAuth callback handler |
| DELETE | `/stadion/v1/google-contacts/disconnect` | Revoke access, cleanup |
| POST | `/stadion/v1/google-contacts/sync` | Trigger immediate sync |
| GET | `/stadion/v1/google-contacts/preferences` | Get sync preferences |
| PUT | `/stadion/v1/google-contacts/preferences` | Update sync preferences |
| GET | `/stadion/v1/google-contacts/conflicts` | List unresolved conflicts |
| POST | `/stadion/v1/google-contacts/conflicts/{id}` | Resolve a conflict |
| GET | `/stadion/v1/google-contacts/log` | Get sync history |
| POST | `/stadion/v1/people/{id}/google-sync` | Sync single contact |
| DELETE | `/stadion/v1/people/{id}/google-link` | Unlink contact from Google |
