...
Plans:
- [x] 111-01: Backend Filtered Endpoint — New `/rondo/v1/people/filtered` endpoint with wpdb JOINs
...
Plans:
- [x] 114-01: REST API Endpoints — GET/PATCH /rondo/v1/user/list-preferences
