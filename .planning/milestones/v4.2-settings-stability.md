...
Improve settings organization, fix React DOM stability issues, and enhance calendar email matching. Focused on stability and UX polish.
...
**Details:**
- Added `rematch_events_for_user()` method to STADION_Calendar_Matcher
