...
|-------|--------|----------|--------|
| 111 | `/stadion/v1/people/filtered` | usePeople.js | WIRED |
...
|-------|--------|----------|------|--------|
| `/stadion/v1/people/filtered` | GET | useFilteredPeople | check_user_approved | CONSUMED |
| `/stadion/v1/user/list-preferences` | GET | useListPreferences | is_user_logged_in | CONSUMED |
| `/stadion/v1/user/list-preferences` | PATCH | useListPreferences | is_user_logged_in | CONSUMED |
