# Requirements Archive: v19.0 Birthdate Simplification

**Archived:** 2026-02-06
**Status:** SHIPPED

This is the archived requirements specification for v19.0.
...
- [x] **DATA-01**: All important_date posts deleted from production database

### Infrastructure Removal

- [x] **REMV-01**: important_date CPT registration removed
- [x] **REMV-02**: date_type taxonomy registration removed
- [x] **REMV-03**: "Datums" navigation item removed from sidebar
- [x] **REMV-04**: DatesList page and route removed
- [x] **REMV-05**: ImportantDateModal component removed
- [x] **REMV-06**: Important dates card removed from PersonDetail
- [x] **REMV-07**: Related REST endpoints removed (/stadion/v1/timeline date entries, etc.)
- [x] **REMV-08**: Unused imports and hooks cleaned up
...
| REMV-01 | Phase 148 | Complete |
| REMV-02 | Phase 148 | Complete |
| REMV-03 | Phase 148 | Complete |
| REMV-04 | Phase 148 | Complete |
| REMV-05 | Phase 148 | Complete |
| REMV-06 | Phase 148 | Complete |
| REMV-07 | Phase 148 | Complete |
| REMV-08 | Phase 148 | Complete |
...
---
*Archived: 2026-02-06 as part of v19.0 milestone completion*
