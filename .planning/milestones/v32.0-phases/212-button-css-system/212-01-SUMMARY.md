...
plan: 01
subsystem: ui
tags: [css, tailwind, button, design-system]
...
tech-stack:
  added: []
  patterns:
    - "Button tiers extend shared .btn base via @apply btn to avoid duplication"
    - "btn-tertiary overrides hover:-translate-y-0.5 from base with hover:translate-y-0 (ghost buttons do not lift)"
    - "btn-danger similarly suppresses lift for destructive actions"
...
requirements-completed: [BTN-01, BTN-02, BTN-03, BTN-04, BTN-05]
