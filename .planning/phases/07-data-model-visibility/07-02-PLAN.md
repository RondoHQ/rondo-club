...
Load class in functions.php in rondo_init() function, after class-access-control.php.
  </action>
  <verify>Create test script that calls RONDO_Visibility::set_visibility() and RONDO_Visibility::add_share() then reads them back</verify>
...
- [ ] RONDO_Visibility class loads without fatal errors
...
- RONDO_Visibility helper class provides clean API for visibility/share operations
