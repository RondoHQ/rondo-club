...
<objective>
Add visibility and sharing post meta fields to Person/Company/Important Date.
...
@.planning/PROJECT.md
@.planning/ROADMAP.md
@Caelis-Multi-User-Project-Plan.md (sections 1.1, 1.5)
...
- Location: post_type == person OR post_type == company OR post_type == important_date
- Position: side
...
Set show_in_rest: true on the field for REST API access.
  ...
  <done>ACF field group appears in WordPress admin, visibility field visible on Person/Company edit screens</done>
</task>

<task type="auto">
  <name>Task 2: Create PRM_Visibility helper class</name>
...
Load class in functions.php in prm_init() function, after class-access-control.php.
  </action>
  <verify>Create test script that calls PRM_Visibility::set_visibility() and PRM_Visibility::add_share() then reads them back</verify>
...
- [ ] Visibility field appears on Company edit screen in admin
- [ ] PRM_Visibility class loads without fatal errors
...
- PRM_Visibility helper class provides clean API for visibility/share operations
