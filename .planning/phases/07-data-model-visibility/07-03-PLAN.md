...
Output: STADION_Workspace_Members class with methods for managing membership data in user meta.
</objective>
...
@.planning/PROJECT.md
@.planning/ROADMAP.md
@Stadion-Multi-User-Project-Plan.md (sections 1.3, 2.3)
...
Load class in functions.php in stadion_init() function.
  </action>
...
- [ ] STADION_Workspace_Members class loads without errors
