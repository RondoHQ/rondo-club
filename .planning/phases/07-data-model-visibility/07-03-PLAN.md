...
Output: RONDO_Workspace_Members class with methods for managing membership data in user meta.
</objective>
...
Load class in functions.php in rondo_init() function.
  </action>
...
- [ ] RONDO_Workspace_Members class loads without errors
