...
Extended PRM_Access_Control to check visibility, workspace membership, and direct shares, enabling contacts to be accessed by workspace members and shared users, not just the author.
