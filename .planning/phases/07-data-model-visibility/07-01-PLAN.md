...
@.planning/PROJECT.md
@.planning/ROADMAP.md
@Caelis-Multi-User-Project-Plan.md (sections 1.2, 1.4, 2.1)
...
- workspace_access taxonomy: hierarchical=false, attached to person, company, important_date
...
Call from register_taxonomies().
  ...
  <done>workspace_access taxonomy registered, visible in admin under People/Organizations, REST API enabled</done>
</task>
...
- No changes to existing functionality (person, company, important_date unchanged)
