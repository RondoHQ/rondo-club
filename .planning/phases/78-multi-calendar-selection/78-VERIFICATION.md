...
|------|----|-----|--------|---------|
| `src/pages/Settings/Settings.jsx` | `/prm/v1/calendar/connections/{id}` | PUT request with calendar_ids array | WIRED | `data.calendar_ids = selectedCalendarIds` at line 1273, sent via `onSave()` |
