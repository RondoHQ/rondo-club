...
- `class-notification-channels.php` contains: RONDO_Notification_Channel (abstract, line 15), RONDO_Email_Channel (line 79), RONDO_Slack_Channel (line 426)
...
1. **Proposed Folder Structure:**
   ...
   - `includes/rest/` - All RONDO_REST_* classes
