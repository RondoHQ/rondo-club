...
must_haves:
  ...
  key_links:
    ...
    - from: "src/api/client.js"
      to: "/prm/v1/calendar/today-meetings"
...
curl -s "https://cael.is/wp-json/prm/v1/calendar/today-meetings" -H "Cookie: ..." | jq '.total'

# Test specific date
curl -s "https://cael.is/wp-json/prm/v1/calendar/today-meetings?date=2026-01-16" -H "Cookie: ..." | jq '.total'
```
