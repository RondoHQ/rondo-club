...
| `src/api/client.js` | getMeetingsForDate API method | VERIFIED | Line 246: `getMeetingsForDate: (date) => api.get('/rondo/v1/calendar/today-meetings', { params: { date } })` |
...
| `src/api/client.js` | `/rondo/v1/calendar/today-meetings` | REST API with date param | WIRED | Line 246: `api.get('/rondo/v1/calendar/today-meetings', { params: { date } })` |
