...
must_haves:
  truths:
    ...
    - "Admin can toggle between People and Teams field lists"
  ...
  key_links:
    - from: "src/pages/Settings/CustomFields.jsx"
      ...
      pattern: "getCustomFields.*person|team"
    - from: "src/App.jsx"
...
Purpose: Enable admins to view existing custom field definitions for People and Teams.
...
2. **Tab navigation**: Two tabs "People Fields" and "Team Fields"
   - Use same border-b tab styling as Labels.jsx
   - Store activeTab in state ('person' or 'team')
...
3. Admin users see Custom Fields page with People/Teams tabs
...
- Tab bar toggles between person and team field lists
