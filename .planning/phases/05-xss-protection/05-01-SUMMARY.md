...
provides:
  - XSS sanitization helpers in RONDO_REST_Base (sanitize_text, sanitize_rich_content, sanitize_url)
...
- Added three protected sanitization helper methods to RONDO_REST_Base class
