...
@.planning/phases/01-rest-api-infrastructure/01-01-SUMMARY.md (established PRM_REST_Base with format methods)
...
<task type="auto">
  <name>Task 1: Add sanitization helper methods to PRM_REST_Base</name>
  <files>includes/class-rest-base.php</files>
  <action>
Add three protected helper methods to PRM_REST_Base for consistent sanitization:
...
Verify methods exist: `grep -E "function sanitize_(text|rich_content|url)" includes/class-rest-base.php`
  ...
  <done>
- Three new protected sanitization methods added to PRM_REST_Base
...
<task type="auto">
  ...
  <action>
Review and sanitize remaining response fields in PRM_REST_API that don't use the base class formatters.
