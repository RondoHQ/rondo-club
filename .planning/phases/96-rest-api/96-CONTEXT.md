...
Build REST API endpoints for feedback CRUD operations under `rondo/v1/feedback`. External tools can create and manage feedback programmatically with application password authentication. Admins can access all feedback; users access only their own.
...
No specific requirements — follow existing rondo/v1 patterns and WordPress REST conventions.
