...
- `post_type` - array: allowed post types to relate to (['person', 'team'])
...
```bash
wp eval "
\$result = wp_remote_post(rest_url('stadion/v1/custom-fields/person'), array(
