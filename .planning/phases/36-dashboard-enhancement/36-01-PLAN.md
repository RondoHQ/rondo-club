...
1. In includes/class-rest-api.php, add a count_awaiting_todos() method:
   - Similar to count_open_todos() but queries 'stadion_awaiting' post_status
...
- Dashboard shows 5 stat cards: People, Teams, Events, Open todos, Awaiting
- Awaiting stat links to /todos?status=awaiting
- API response at /stadion/v1/dashboard includes awaiting_todos_count
  </verify>
  <done>
