...
<task type="auto">
  ...
  <action>
Update `RONDO_Access_Control` to handle the new `stadion_todo` post type:
...
This ensures todos follow same visibility/workspace rules as person, team, important_date.
  </action>
  <verify>
...
- [ ] `RONDO_Access_Control::$controlled_post_types` includes `stadion_todo`
</verification>
