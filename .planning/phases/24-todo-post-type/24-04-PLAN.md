...
<task type="auto">
  ...
  <action>
In `RONDO_REST_API`, add new method to count open todos from CPT and update dashboard:
...
3. **REST API - CRUD:**
   - `test_get_todos_returns_user_todos()` - GET /rondo/v1/todos returns user's todos
   - `test_get_person_todos_filters_by_person()` - GET /rondo/v1/people/{id}/todos filters
...
- [ ] `GET /rondo/v1/dashboard` returns accurate `open_todos_count`
