...
- STADION_ENCRYPTION_KEY - 32-byte key for sodium encryption of Slack tokens
...
1. STADION_ENCRYPTION_KEY - must be exactly 32 bytes for sodium_crypto_secretbox
2. STADION_SLACK_CLIENT_ID - from Slack app settings
3. STADION_SLACK_CLIENT_SECRET - from Slack app settings
4. STADION_SLACK_SIGNING_SECRET - from Slack app settings
