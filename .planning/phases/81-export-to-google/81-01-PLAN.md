...
<task type="auto">
  ...
  <action>
Add the new export class to the list of included files in `rondo_init()` function.
...
Verify the require_once line is in the correct location within rondo_init().
  </verify>
  <done>
