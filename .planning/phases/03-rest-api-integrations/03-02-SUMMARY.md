...
provides:
  - RONDO_REST_Import_Export class with import/export and CardDAV REST endpoints
...
**Extract import/export and CardDAV endpoints from RONDO_REST_API into dedicated RONDO_REST_Import_Export class**
...
- Created RONDO_REST_Import_Export class extending RONDO_REST_Base with 3 routes and 5 methods
...
1. **Task 1: Create RONDO_REST_Import_Export class with routes and methods** - `40be27b` (feat)
2. **Task 2: Remove export methods from RONDO_REST_API and update autoloader** - `1c0fbfc` (refactor)
...
- Plan 03-01: Slack endpoints extracted to RONDO_REST_Slack
- Plan 03-02: Import/Export endpoints extracted to RONDO_REST_Import_Export
...
- RONDO_REST_Base (abstract base)
- RONDO_REST_API (remaining general endpoints)
- RONDO_REST_People (people-specific endpoints)
- RONDO_REST_Teams (team-specific endpoints)
- RONDO_REST_Slack (Slack integration endpoints)
- RONDO_REST_Import_Export (export and CardDAV endpoints)
