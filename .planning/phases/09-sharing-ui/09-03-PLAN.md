...
```php
// Sharing endpoints
register_rest_route('rondo/v1', '/people/(?P<id>\d+)/shares', [
    [
        'methods' => 'GET',
...
register_rest_route('rondo/v1', '/people/(?P<id>\d+)/shares/(?P<user_id>\d+)', [
    'methods' => 'DELETE',
...
register_rest_route('rondo/v1', '/users/search', [
    'methods' => 'GET',
...
```
  ...
  <verify>Test endpoints via curl or browser - GET /rondo/v1/people/{id}/shares should return empty array for unshared post</verify>
...
```javascript
// In prmApi object:
getPostShares: (postType, postId) => api.get(`/rondo/v1/${postType}/${postId}/shares`),
addShare: (postType, postId, userId, permission) => api.post(`/rondo/v1/${postType}/${postId}/shares`, { user_id: userId, permission }),
removeShare: (postType, postId, userId) => api.delete(`/rondo/v1/${postType}/${postId}/shares/${userId}`),
