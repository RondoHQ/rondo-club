...
- GET/POST /rondo/v1/workspaces - List/create workspaces
- GET/PUT/DELETE /rondo/v1/workspaces/{id} - Workspace CRUD
- POST/DELETE/PUT /rondo/v1/workspaces/{id}/members - Member management
- GET/POST /rondo/v1/workspaces/{id}/invites - Invite management
- DELETE /rondo/v1/workspaces/{id}/invites/{invite_id} - Revoke invite
- GET /rondo/v1/invites/{token} - Validate invite (public)
- POST /rondo/v1/invites/{token}/accept - Accept invite
...
```javascript
// Workspaces
getWorkspaces: () => api.get('/rondo/v1/workspaces'),
getWorkspace: (id) => api.get(`/rondo/v1/workspaces/${id}`),
createWorkspace: (data) => api.post('/rondo/v1/workspaces', data),
updateWorkspace: (id, data) => api.put(`/rondo/v1/workspaces/${id}`, data),
deleteWorkspace: (id) => api.delete(`/rondo/v1/workspaces/${id}`),

// Workspace members
addWorkspaceMember: (workspaceId, data) => api.post(`/rondo/v1/workspaces/${workspaceId}/members`, data),
removeWorkspaceMember: (workspaceId, userId) => api.delete(`/rondo/v1/workspaces/${workspaceId}/members/${userId}`),
updateWorkspaceMember: (workspaceId, userId, data) => api.put(`/rondo/v1/workspaces/${workspaceId}/members/${userId}`, data),

// Workspace invites
getWorkspaceInvites: (workspaceId) => api.get(`/rondo/v1/workspaces/${workspaceId}/invites`),
createWorkspaceInvite: (workspaceId, data) => api.post(`/rondo/v1/workspaces/${workspaceId}/invites`, data),
revokeWorkspaceInvite: (workspaceId, inviteId) => api.delete(`/rondo/v1/workspaces/${workspaceId}/invites/${inviteId}`),

// Public invite endpoints (no auth required for validation)
validateInvite: (token) => api.get(`/rondo/v1/invites/${token}`),
acceptInvite: (token) => api.post(`/rondo/v1/invites/${token}/accept`),

// Sharing (for ShareModal - uses existing _shared_with meta)
getPostShares: (postId, postType) => api.get(`/rondo/v1/${postType}/${postId}/shares`),
sharePost: (postId, postType, data) => api.post(`/rondo/v1/${postType}/${postId}/shares`, data),
unsharePost: (postId, postType, userId) => api.delete(`/rondo/v1/${postType}/${postId}/shares/${userId}`),
