...
- GET/POST /stadion/v1/workspaces - List/create workspaces
- GET/PUT/DELETE /stadion/v1/workspaces/{id} - Workspace CRUD
- POST/DELETE/PUT /stadion/v1/workspaces/{id}/members - Member management
- GET/POST /stadion/v1/workspaces/{id}/invites - Invite management
- DELETE /stadion/v1/workspaces/{id}/invites/{invite_id} - Revoke invite
- GET /stadion/v1/invites/{token} - Validate invite (public)
- POST /stadion/v1/invites/{token}/accept - Accept invite
