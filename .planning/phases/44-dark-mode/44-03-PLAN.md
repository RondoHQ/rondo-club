...
<task type="auto">
  <name>Task 1: Add dark mode to Person/Company/Date edit modals</name>
  <files>src/components/PersonEditModal.jsx, src/components/CompanyEditModal.jsx, src/components/ImportantDateModal.jsx</files>
  <action>
...
Preserve all existing classes - only add dark: variants.
  ...
  <done>PersonEditModal, CompanyEditModal, ImportantDateModal display correctly in dark mode</done>
</task>
...
- [ ] CompanyEditModal form elements visible in dark mode
