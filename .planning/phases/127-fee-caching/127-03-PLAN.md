...
```
  ...
  <done>
Admin-only REST endpoint POST /stadion/v1/fees/recalculate clears caches and schedules bulk recalculation.
  </done>
</task>
...
- Admin can POST to /stadion/v1/fees/recalculate to force recalculation
