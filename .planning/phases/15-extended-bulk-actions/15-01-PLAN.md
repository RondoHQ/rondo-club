...
Output: Extended `/stadion/v1/people/bulk-update` endpoint accepting team_id, labels_add, and labels_remove parameters.
</objective>
...
curl -X POST "http://localhost/wp-json/stadion/v1/people/bulk-update" \
