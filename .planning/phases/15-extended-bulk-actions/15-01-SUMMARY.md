...
## Overview
Extended the bulk-update REST endpoint (`/stadion/v1/people/bulk-update`) to support team assignment and label management operations, enabling backend support for Phase 15's extended bulk actions.
