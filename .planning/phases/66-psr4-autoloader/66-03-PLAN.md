...
- RONDO_Monica_Import → Stadion\Import\Monica
- RONDO_VCard_Import → Stadion\Import\VCard
- RONDO_Google_Contacts_Import → Stadion\Import\GoogleContacts
- RONDO_VCard_Export → Stadion\Export\VCard
- RONDO_ICal_Feed → Stadion\Export\ICalFeed
- RONDO_CardDAV_Server → Stadion\CardDAV\Server
- RONDO_Inverse_Relationships → Stadion\Data\InverseRelationships
- RONDO_Todo_Migration → Stadion\Data\TodoMigration
- RONDO_Credential_Encryption → Stadion\Data\CredentialEncryption
...
- `class RONDO_Monica_Import` → `class Monica`
- `class RONDO_VCard_Import` → `class VCard`
- `class RONDO_Google_Contacts_Import` → `class GoogleContacts`
...
- `class RONDO_VCard_Export` → `class VCard`
- `class RONDO_ICal_Feed` → `class ICalFeed`
...
Rename:
- `class RONDO_CardDAV_Server` → `class Server`
...
Rename data classes:
- `class RONDO_Inverse_Relationships` → `class InverseRelationships`
- `class RONDO_Todo_Migration` → `class TodoMigration`
- `class RONDO_Credential_Encryption` → `class CredentialEncryption`
