...
provides:
  - Bulk update REST endpoint /prm/v1/people/bulk-update
...
- Created POST endpoint `/prm/v1/people/bulk-update` with ownership validation
- Implemented visibility updates using PRM_Visibility helper
