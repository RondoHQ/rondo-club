...
must_haves:
  truths:
    ...
    - "Person header shows at Team with proper spacing"
  artifacts:
    ...
    - path: "src/pages/People/PersonDetail.jsx"
      provides: "Person header with team link"
      contains: " at "
  key_links:
...
<task type="auto">
  ...
  <action>
    ...
    2. **PersonDetail.jsx (line 1469):**
       ...
       - This creates proper spacing between "at" and the team name link
  </action>
  <verify>
  ...
  <done>
    ...
    - Person header shows "Role at TeamName" with proper spacing
  </done>
</task>
...
3. Test on production (https://cael.is/):
   ...
   - Verify person header shows "Title at TeamName" with proper spacing
