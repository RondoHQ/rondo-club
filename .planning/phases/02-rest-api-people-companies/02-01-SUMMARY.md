...
provides:
  - RONDO_REST_People class with people-specific REST endpoints
...
**Extract people-related REST API endpoints into dedicated RONDO_REST_People class**
...
- Created RONDO_REST_People class extending RONDO_REST_Base with 5 people-specific methods
- Registered 3 REST routes: /people/{id}/dates, /people/{id}/gravatar, /people/{id}/photo
- Moved rest_prepare_person filters to RONDO_REST_People for domain encapsulation
...
1. **Task 1: Create RONDO_REST_People class with routes and methods** - `410b9b3` (feat)
2. **Task 2: Remove people methods from RONDO_REST_API** - `71979cc` (refactor)
...
- Registered both routes and filters in RONDO_REST_People constructor for complete domain ownership
- Used RONDO_REST_Base permission methods (check_person_access, check_person_edit_permission) as callbacks
- Used RONDO_REST_Base formatting method (format_date) for response formatting
...
- RONDO_REST_Base inheritance proven to work for domain-specific classes
