...
1. **Stats row** (5 stat cards) - Total people, Teams, Events, Open todos, Awaiting
...
1. `GET /rondo/v1/user/dashboard-settings` - Return user's dashboard settings:
   ```json
   {
...
2. `PATCH /rondo/v1/user/dashboard-settings` - Update settings:
...
const CARD_DEFINITIONS = [
  { id: 'stats', label: 'Statistics', description: 'People, teams, events counts' },
