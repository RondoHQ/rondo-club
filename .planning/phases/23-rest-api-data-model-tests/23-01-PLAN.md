...
Purpose: Verify standard REST API endpoints work correctly for person, team, and important_date post types with proper access control and field handling.
...
<task type="auto">
  ...
  <action>
Create CptCrudTest extending StadionTestCase. Test WordPress standard REST API at /wp/v2/people:
...
<task type="auto">
  <name>Task 2: Test CRUD for team and important_date CPTs</name>
  <files>tests/Wpunit/CptCrudTest.php</files>
  <action>
Extend CptCrudTest with team and important_date CRUD tests:

1. Test team CRUD at /wp/v2/teams:
...
3. Test ACF fields in REST responses:
   ...
   - Create team with ACF fields (website, industry)
   - GET team, verify ACF fields
