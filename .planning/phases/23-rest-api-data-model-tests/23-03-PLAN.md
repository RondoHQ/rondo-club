...
1. Test sharing endpoints for people (/rondo/v1/people/{id}/shares):
...
3. Test sharing for teams:
   - Same tests as people at /rondo/v1/teams/{id}/shares

4. Test bulk update for people (/rondo/v1/people/bulk-update):
   - Create 3 persons
...
6. Test bulk update for teams:
   - Similar tests at /rondo/v1/teams/bulk-update
  </action>
