...
<task type="auto">
  ...
  <action>
Add a new WP-CLI command `wp stadion migrate-birthdates` to the STADION_Migration_CLI_Command class (or create the class if needed):

1. **Register the command** (in the WP_CLI section at bottom of file):
   ```php
