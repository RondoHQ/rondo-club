...
<task type="auto">
  ...
  <action>
    ...
    **src/pages/Settings/Settings.jsx:**
    ...
    3. Implement the save handler using the existing `prmApi` pattern (Settings.jsx already uses this for rondo/v1 calls):
  ...
  <done>
    ...
    - Save persists via POST /rondo/v1/config
