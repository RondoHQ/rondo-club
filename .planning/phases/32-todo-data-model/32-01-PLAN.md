...
- `prm_todo` CPT with custom post statuses (`prm_open`, `prm_awaiting`, `prm_completed`)
...
- REST API in `includes/class-rest-todos.php`:
  - Person-scoped: `GET/POST /prm/v1/people/{id}/todos`
  - Global: `GET /prm/v1/todos`, `GET/PUT/DELETE /prm/v1/todos/{id}`
