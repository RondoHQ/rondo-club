...
provides:
  ...
  - Text domain correction (personal-crm -> caelis)
...
- Fixed all text domain issues (453 occurrences of 'personal-crm' -> 'caelis')
...
**1. [Text Domain] Bulk replacement of 'personal-crm' with 'caelis'**
