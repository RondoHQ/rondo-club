...
This matches the format returned by STADION_REST_Todos::format_todo() which already includes thumbnail.
  </action>
  <verify>curl http://localhost/wp-json/stadion/v1/people/{id}/timeline returns todos with persons[].thumbnail field</verify>
