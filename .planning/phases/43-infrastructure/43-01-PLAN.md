...
1. Register GET endpoint: `/rondo/v1/user/theme-preferences`
...
2. Register PATCH endpoint: `/rondo/v1/user/theme-preferences`
...
- getThemePreferences: () => apiClient.get('/rondo/v1/user/theme-preferences')
- updateThemePreferences: (prefs) => apiClient.patch('/rondo/v1/user/theme-preferences', prefs)
  </action>
  <verify>Test endpoints with curl or in browser console:
- GET /wp-json/rondo/v1/user/theme-preferences returns default values
