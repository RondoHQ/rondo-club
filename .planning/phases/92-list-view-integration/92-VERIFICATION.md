...
| CompaniesList.jsx | /stadion/v1/custom-fields/company/metadata | useQuery with prmApi.getCustomFieldsMetadata('company') | WIRED | Line 432 calls API, response stored in customFields |
