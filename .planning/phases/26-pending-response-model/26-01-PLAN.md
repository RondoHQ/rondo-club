...
The auto-timestamp logic ensures awaiting_response_since is always accurate - users don't manually set it.
  ...
  <verify>curl -X GET localhost/wp-json/stadion/v1/todos shows awaiting_response and awaiting_response_since fields in response</verify>
