...
- Confirmed RONDO_REST_API correctly extends RONDO_REST_Base
...
### Class Inheritance
- RONDO_REST_API extends: **RONDO_REST_Base** (verified)
- RONDO_REST_Base is abstract: **yes**
...
| Metric | Value |
|--------|-------|
| Total routes in RONDO_REST_API | 37 |
| Methods in RONDO_REST_Base | 9 |
