...
must_haves:
  ...
  key_links:
    - from: "src/hooks/useListPreferences.js"
      to: "/rondo/v1/user/list-preferences"
      via: "prmApi GET and PATCH"
      pattern: "rondo/v1/user/list-preferences"
---
...
```
  ...
  <done>
- GET /rondo/v1/user/list-preferences returns column_order and column_widths
- PATCH /rondo/v1/user/list-preferences accepts column_order and column_widths
...
2. Use TanStack Query patterns already established in codebase:
   ...
   - queryFn: GET /rondo/v1/user/list-preferences via prmApi
...
Import from '@/api/client' using prmApi (not wpApi) for /rondo/v1 namespace.
  </action>
  <verify>
...
- Hook fetches preferences from /rondo/v1/user/list-preferences
...
<success_criteria>
- GET /rondo/v1/user/list-preferences returns { visible_columns, column_order, column_widths, available_columns }
