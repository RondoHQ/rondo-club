...
| `includes/class-wp-cli.php` | WP-CLI command for event title cleanup | VERIFIED | Lines 2271-2370: RONDO_Event_CLI_Command class with cleanup_titles method, registered at line 2369 |
...
| CLI command | WP system | WP_CLI::add_command | WIRED | Line 2369: `WP_CLI::add_command( 'prm event', 'RONDO_Event_CLI_Command' );` |
