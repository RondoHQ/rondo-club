...
provides:
  ...
  - StadionTestCase base class with factory helpers
  - Test database (stadion_test) isolation
...
- Created test database `stadion_test` via Homebrew MySQL
- Configured WPLoader module with theme symlink and ACF Pro activation
- Built StadionTestCase base class with factory helpers for all CPTs
...
- `tests/Support/StadionTestCase.php` - Base test case with factory helpers
...
- **Theme symlink:** Created symlink from WordPress themes directory to Stadion development folder for WPLoader to find theme
...
- **Issue:** MySQL CLI not available on system, couldn't create stadion_test database
...
- **Issue:** WPLoader couldn't find theme "stadion" in WordPress themes directory
- **Fix:** Created symlink `/Users/joostdevalk/Local Sites/personal-crm/app/public/wp-content/themes/stadion -> /Users/joostdevalk/Code/stadion`
