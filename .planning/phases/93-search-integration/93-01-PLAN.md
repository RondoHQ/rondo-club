...
<task type="auto">
  ...
  <action>
Add two private helper methods to RONDO_REST_API class:
...
PHP syntax check: `php -l includes/class-rest-api.php` passes without errors
  ...
  <done>
Two helper methods exist in RONDO_REST_API class that can retrieve searchable field names and build meta queries
  </done>
</task>
