...
- GET /stadion/v1/user/list-preferences (returns visible_columns and available_columns)
- PATCH /stadion/v1/user/list-preferences (saves visible_columns to user_meta)
  </what-built>
  <how-to-verify>
...
```javascript
fetch('/wp-json/stadion/v1/user/list-preferences', {
...
```javascript
fetch('/wp-json/stadion/v1/user/list-preferences').then(r => console.log('Status:', r.status));
```
