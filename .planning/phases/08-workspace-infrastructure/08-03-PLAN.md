...
**Established patterns:** Taxonomy registration in RONDO_Taxonomies
...
<task type="auto">
  ...
  <action>
Add workspace term sync to RONDO_Taxonomies:
...
4. sync_contact_workspace_terms($post_id):
   - Only run for person, team, important_date post types
