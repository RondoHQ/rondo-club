...
1. **class-notification-channel.php** - Contains `STADION_Notification_Channel` abstract class
   - Copy lines 1-74 (file header + abstract class)
   - Add file header comment "Abstract base class for notification channels"

2. **class-email-channel.php** - Contains `STADION_Email_Channel` class
   - Add file header comment "Email notification channel"
   - Add ABSPATH check
   - Copy lines 79-420 (class STADION_Email_Channel)

3. **class-slack-channel.php** - Contains `STADION_Slack_Channel` class
   - Add file header comment "Slack notification channel"
   - Add ABSPATH check
   - Copy lines 426-end (class STADION_Slack_Channel)
...
```php
'STADION_Notification_Channel'     => 'class-notification-channels.php',
'STADION_Email_Channel'            => 'class-notification-channels.php',
'STADION_Slack_Channel'            => 'class-notification-channels.php',
```

With:
```php
'STADION_Notification_Channel'     => 'class-notification-channel.php',
'STADION_Email_Channel'            => 'class-email-channel.php',
'STADION_Slack_Channel'            => 'class-slack-channel.php',
```
