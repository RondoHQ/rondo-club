---
status: verifying
trigger: "Searching for 'Rakt' doesn't find 'Bastiaan van de Rakt' (ID 21) when trying to add an investor to a company"
...
hypothesis: CONFIRMED - The per_page: 100 limit in the people/companies fetch means older records beyond position 100 are never loaded
...
reproduction: Go to company 3316 (Deeploy), try to add an investor, search for "Rakt"
...
- timestamp: 2026-01-23T10:05:00Z
  checked: CompanyEditModal.jsx investor search implementation
...
- timestamp: 2026-01-23T10:15:00Z
  checked: API call in CompanyEditModal (line 49)
...
root_cause: CompanyEditModal fetches at most 100 people/companies client-side and filters locally. WordPress REST API returns posts sorted by date descending (newest first). If there are more than 100 people, older people like ID 21 won't be loaded and can't be found by the local search filter.
