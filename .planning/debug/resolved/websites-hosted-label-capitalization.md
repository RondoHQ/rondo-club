---
status: resolved
trigger: "Custom field '# Websites hosted' is being displayed as '# WEBSITES HOSTED' (fully uppercased) on the team list page"
...
reproduction: View the team list page, look at the "# Websites hosted" column header
...
- timestamp: 2026-01-21T12:05:00Z
  checked: TeamsList.jsx line 469-477 - custom field column headers
...
- timestamp: 2026-01-21T12:05:00Z
  checked: TeamsList.jsx line 409 - SortableHeader component
...
fix: Remove "uppercase" class from custom field column headers in both TeamsList.jsx and PeopleList.jsx
verification: Build successful, deployed to production at https://cael.is/
files_changed:
  - src/pages/Teams/TeamsList.jsx (line 473)
