...
Plans:
- [ ] 180-01-PLAN.md — Backend invoiced-cases endpoint + Tuchtzaken tab selection UI with invoice creation
- [ ] 180-02-PLAN.md — Invoice display on member profile sidebar
...
| 180. Invoice Creation Flow | v26.0 | 0/2 | Planned | - |
