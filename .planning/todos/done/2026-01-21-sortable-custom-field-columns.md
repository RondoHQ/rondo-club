...
Custom field columns in the team and people list views cannot currently be sorted. Standard columns (Name, Industry, etc.) support sorting, but user-defined custom fields added via ACF do not have sorting functionality.
