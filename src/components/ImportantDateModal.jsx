...
export default function ImportantDateModal({ 
  ...
  useEffect(() => {
    // Check if title appears to be auto-generated (either empty or matches known patterns)
    // Match patterns like "Name's Birthday" or "Wedding of Name"
    const autoGeneratedPatterns = ["'s ", "Wedding of "];
    const isAutoGenerated = !watchedTitle || autoGeneratedPatterns.some(p =>
      watchedTitle.includes(p)
    );
