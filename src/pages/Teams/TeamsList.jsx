...
// Bulk Visibility Modal Component for Teams
  ...
  const visibilityOptions = [
    {
      value: 'private',
      label: 'Prive',
      description: 'Alleen jij kunt deze teams zien',
      icon: Lock
    },
    {
      value: 'workspace',
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        <div className="p-4 space-y-4">
          <p className="text-sm text-gray-600 dark:text-gray-300">
            Kies zichtbaarheid voor {selectedCount} {selectedCount === 1 ? 'team' : 'teams'}:
          </p>
        ...
        <div className="flex justify-end gap-2 p-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
          ...
          <button
            ...
            disabled={isLoading}
          >
            {isLoading ? 'Toepassen...' : `Toepassen op ${selectedCount} ${selectedCount === 1 ? 'team' : 'teams'}`}
          </button>
        </div>
      </div>
    </div>
...
// Bulk Workspace Modal Component for Teams
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        <div className="p-4 space-y-4">
          <p className="text-sm text-gray-600 dark:text-gray-300">
            Selecteer workspaces voor {selectedCount} {selectedCount === 1 ? 'team' : 'teams'}:
          </p>
        ...
        <div className="flex justify-end gap-2 p-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
          ...
          >
            {isLoading ? 'Toewijzen...' : `Toewijzen aan ${selectedCount} ${selectedCount === 1 ? 'team' : 'teams'}`}
          </button>
        </div>
      </div>
    </div>
