...
export default function PersonDetail() {
  ...
  const hasValidLidTot = !!(person?.acf?.['lid-tot'] && isValidDate(person.acf['lid-tot']));
  const formattedLidTot = hasValidLidTot ? format(parseISO(person.acf['lid-tot']), 'd MMMM yyyy') : null;
