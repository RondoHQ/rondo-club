  ...
  const content = (
    <div className="card p-4">
      ...
      {statusItems.length === 0 ? (
        <p className="text-xs text-gray-400 dark:text-gray-500 text-center py-3">Geen actieve statussen</p>
      ) : (
...
function FacturenBedragenCard({ openstaandBedrag, openstaandCount, href }) {
  const content = (
    <div className="card p-4">
      <div className="flex items-center justify-between mb-2">
