...
export const FIELD_SIZES = [{ value: 1, label: 'Kwart veld' }, { value: 2, label: 'Half veld' }, { value: 4, label: 'Heel veld' }];
...
export const fieldPart = (block) => 'ABCD'.slice(block.offset, block.offset + block.size);
...
export const schedulePayload = ({ name, season, revision, blocks }) => ({ name, season, revision, blocks });
