...
export const prmApi = {
  ...
  inviteTournamentTeams: (id, assignments) => api.post(`/rondo/v1/tournaments/${id}/invite`, { assignments }),
  ...
  addHouseholdParent: (personId, data) => api.post(`/rondo/v1/people/${personId}/household-parent`, data),
  ...
  cancelProfileEmailChange: (personId) => api.delete('/rondo/v1/user/profile-email/pending', { params: { person_id: personId } }),
  removeSecondaryProfileEmail: (personId) => api.delete('/rondo/v1/user/profile-email/secondary', { params: { person_id: personId } }),
  ...
  // Reusable guest-pass slots for the configured team
  ...
  getFeatureToggles: () => api.get('/rondo/v1/settings/feature-toggles'),
  updateFeatureToggles: (states) => api.put('/rondo/v1/settings/feature-toggles', { states }),
